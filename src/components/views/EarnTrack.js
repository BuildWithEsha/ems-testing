  ...
  return (
    <div className={`flex flex-col min-h-full rounded-lg overflow-hidden ${bgBase}`}>
      <div className="flex flex-col flex-1 p-6 relative w-full max-w-4xl mx-auto">
        ...
        {/* Settings strip: single row, right-aligned; more space from top (row 2) */}
        <div className={`flex flex-row items-center justify-center mb-3 mt-8 relative z-10 ${showSettings ? 'min-h-[3.25rem]' : 'min-h-0 overflow-hidden'}`}>
          {showSettings && (
